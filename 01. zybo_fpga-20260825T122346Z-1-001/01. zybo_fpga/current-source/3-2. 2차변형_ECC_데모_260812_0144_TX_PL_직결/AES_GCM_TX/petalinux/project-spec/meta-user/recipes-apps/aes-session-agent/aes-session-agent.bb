SUMMARY = "X25519 authenticated AES-GCM session key agent (TX)"
LICENSE = "CLOSED"
...
SRC_URI = "file://aes_session_agent.c file://aes_session_regs.c file://aes_session_regs.h \
           ...
           file://aes-session-tx.init file://aes-session-wifi file://aes-session-check file://wpa.conf \
           file://tx-demo-private.pem file://rx-demo-public.pem"
...
INITSCRIPT_PARAMS:${PN} = "start 96 S . stop 20 0 1 6 ."
...
do_install() {
    ...
    install -m 0755 ${WORKDIR}/aes-session-tx.init ${D}${sysconfdir}/init.d/aes-session-agent
    ...
    install -m 0600 ${WORKDIR}/tx-demo-private.pem ${D}${sysconfdir}/aes-session/tx-private.pem
    install -m 0644 ${WORKDIR}/rx-demo-public.pem ${D}${sysconfdir}/aes-session/rx-public.pem
}
