...
module aes_session_key_regs #(
    ...
    // Final physical-demo behavior is active-high.  RX disables physical
    // requests in its wrapper because TX is the session-key initiator.
    ...
    // This closes the check-to-START window where a remote termination could
    // otherwise clear the key before the first AXIS beat arrived.
    logic         frame_lock;
