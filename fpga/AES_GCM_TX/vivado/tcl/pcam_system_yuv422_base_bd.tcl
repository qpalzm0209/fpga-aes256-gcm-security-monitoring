...
\
  ...
  # Create instance: video_aes_gcm_switch, and set properties
  set block_name axis_video_aes_gcm_switch_bd
  set block_cell_name video_aes_gcm_switch
  if { [catch {set video_aes_gcm_switch [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $video_aes_gcm_switch eq "" } {
  ...
  connect_bd_intf_net -intf_net aes_switch_to_yuv_pack [get_bd_intf_pins video_aes_gcm_switch/m_axis] [get_bd_intf_pins axis_yuv422_16_to_24/S_AXIS]
  ...
  connect_bd_intf_net -intf_net yuv422_norm_to_aes_switch [get_bd_intf_pins yuv422_axis_norm/M_AXIS] [get_bd_intf_pins video_aes_gcm_switch/s_axis]
  ...
  [get_bd_pins video_aes_gcm_switch/aclk] \
  ...
  [get_bd_pins video_aes_gcm_switch/aresetn] \
  ...
  [get_bd_pins video_aes_gcm_switch/sw3_encrypt]
